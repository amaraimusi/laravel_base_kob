...
<nav class="navbar navbar-expand-lg navbar-light bg-success">
	<a class="navbar-brand text-light" href="<?php echo 'xxx';?>">CrudBase</a>
			...
			<li class="nav-item dropdown">
				@auth
					...
					<div class="dropdown-menu dropdown-menu-right" aria-labelledby="username_navbarDropdownMenuLink">
						...
						<a class=" btn btn-info btn-sm dropdown-item" href="<?php echo '';?>/ajax_login_with_cake/logout" >ログアウト</a>
					</div>
				@else
